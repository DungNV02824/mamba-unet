...
# #             VSSBlock(hidden_dim=dim, drop_path=drop_path[j] if isinstance(drop_path, list) else drop_path)
...
#         # BOTTLENECK (tăng depth cho mạnh hơn)
...
# def create_mamba_unet(in_chans=1, num_classes=2, img_size=512,embed_dim=64):
#     return MambaUNet(
#         img_size=img_size,
#         in_chans=in_chans,
#         num_classes=num_classes,
